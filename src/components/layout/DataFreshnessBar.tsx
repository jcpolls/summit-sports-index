...
export function DataFreshnessBar() {
  ...
  return (
    <div className="border-t bg-muted/30 px-6 py-1.5 flex items-center gap-6 overflow-x-auto shrink-0">
      ...
      {SOURCES.map((source) => {
        ...
        return (
          <div key={source.label} className="flex items-center gap-1.5 shrink-0">
            ...
            <span className={`text-[11px] font-medium ${freshnessColor(minutesAgo)}`}>
